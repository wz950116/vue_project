    ...
    <div style="padding-top:20px;">
        ...
        <el-table :data="tableData" border style="width:100%;" selection-mode="multiple">
            ...
            <el-table-column inline-template label="纳税资质" min-width="120" align="center">
                <span>
                    <span style="cursor:pointer;color:blue;" v-if="row.taxpayerCertMd5"
            ...
            <el-table-column v-if="tableData.length>0" inline-template label="操作" fixed="right" width="160"
                ...
                <div class="action" style="text-align:center;">
                    <el-button type="success" size="small" v-show="row.status!=1" @click="setAudit(row, 1)">通过
                    </el-button>
                    <el-button type="danger" size="small" v-show="row.status!=2" @click="setAudit(row, 2)">驳回
                    </el-button>
                </div>
            </el-table-column>
...
<script>
    ...
    import qualificationHeader from "../qualification-header/qualification-header";
    export default{
        data () {
            return {
                currentPage: 1,
